...
public class ProductService {
    ...
    @Autowired
    public ProductService(@Qualifier(ProductRepository.MY_SQL_REPO_BEAN_NAME) final ProductRepository repository,
                          @Qualifier(ProductRepository.ORACLE_REPO_BEAN_NAME) final ProductRepository oracleProductRepository) {
